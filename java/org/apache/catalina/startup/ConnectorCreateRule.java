...
public class ConnectorCreateRule extends Rule {
    ...
    public void begin(String namespace, String name, Attributes attributes)
        ...
        /**
         * 获取Connector节点的属性executor值，如果有的话，就从Service组件中找到对应的线程池对象
         * 因为如果用户在server.xml中配置了Executor节点，肯定会被添加到Service实例对象中的
         * 而Connector的executor的值必须和xml中配置的Executor节点的name保持一样
         */
        ...
        /**
         * 构建连接器对象，传入指定的协议：org.apache.coyote.http11.Http11NioProtocol
         * 可以传 "HTTP/1.1" 或 "AJP/1.3"，也可以传入相应的协议处理器类，如：
         * org.apache.coyote.http11.Http11NioProtocol：对应非阻塞 IO {@link org.apache.coyote.http11.Http11NioProtocol}
         * org.apache.coyote.http11.Http11Nio2Protocol：对应异步 IO {@link org.apache.coyote.http11.Http11Nio2Protocol}
