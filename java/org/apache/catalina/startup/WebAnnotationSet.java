...
public class WebAnnotationSet {
    ...
    public static void loadApplicationAnnotations(Context context) {
        /**处理Listener（加载class字节码拿到class、处理类的注解、类中字段成员的注解及方法的注解）*/
        loadApplicationListenerAnnotations(context);
        /**处理Filter（加载class字节码拿到class、处理类的注解、类中字段成员的注解及方法的注解）*/
        loadApplicationFilterAnnotations(context);
        /**处理Servlet（加载class字节码拿到class、处理类的注解、类中字段成员的注解及方法的注解）*/
