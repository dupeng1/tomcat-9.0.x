...
public class StandardEngine extends ContainerBase implements Engine {
    ...
    public StandardEngine() {
        ...
        System.out.println("--------》StandardEngine构造器，往pipeline中添加StandardEngineValve实例");
     ...
     * of Host.
     * 添加子容器，仅当建议的子容器是主机的实现时。
     * @param child Child container to be added
     */
    @Override
    public void addChild(Container child) {
        /**如果不是Host类型的，直接抛异常，也就是server.xml中时规范的，不能瞎搞*/
    ...
    protected synchronized void startInternal() throws LifecycleException {
         ...
         * 标准容器启动，最小单元是host（{@link StandardHost}），对应server.xml中的结构
         * 区别于{@link StandardServer}和{@link StandardService},这俩家属于生命周期组件概念，不属于Catalina容器
         * （白话就是：没有继承{@link ContainerBase}抽象类或者实现{@link Container}接口）
         * 所谓的Catalina容器是从StandardEngine开始的，所以从StandardEngine开始，其startInternal方法都会
         * 调用父类{@link ContainerBase#startInternal()}的启动方法
         */
        super.startInternal();
    }
