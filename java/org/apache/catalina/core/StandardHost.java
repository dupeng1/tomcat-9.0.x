...
public class StandardHost extends ContainerBase implements Host {
    ...
    public StandardHost() {
        ...
        System.out.println("--------》StandardHost构造器，往pipeline中添加StandardHostValve实例");
     ...
     * 我们是否应该在启动时为appBase和xmlBase创建目录
     */
    ...
    /**
     * ({@inheritDoc} 获取当前主机部署context描述符的配置文件file对象
     */
    @Override
     ...
     * of Context. 给当前的容器添加一个子容器，比如一个虚拟主机下面可以有多个Context等
     *
    ...
    public void addChild(Container child) {
        ...
        if (!(child instanceof Context)) { // 子容器必须是Context类型的，否则抛异常
            throw new IllegalArgumentException
    ...
    protected synchronized void startInternal() throws LifecycleException {
        ...
        /**获取错误报告阀门类的完全限定名：org.apache.catalina.valves.ErrorReportValve*/
        ...
        if ((errorValve != null) && (!errorValve.equals(""))) {
            try {
                ...
                /**如果没有找到，就反射一个然后追加到当前容器的管道中的阀门链条上*/
                if(!found) {
        ...
        /**继续调用父类{@link ContainerBase#startInternal()}*/
        super.startInternal();
    }
