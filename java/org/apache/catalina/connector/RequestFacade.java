 ...
 * 包装 Coyote 请求对象的外观类。所有方法都委托给包装的请求
 * 设计模式：门面/外观
 * 问：为什么tomcat要自己再搞个Request呢？
 * 答：怕你(servlet开发人员)乱用，又怕你不知道怎么用，所以就用Facade模式，对Request包装了一下，Request是Tomcat的核心
 *    包含了各种http协议的解析工作，这些无需对用户进行暴露，所以弄个请求/响应的门面类来隐藏无关的复杂操作！
 * 这种设计模式举例：
 * 答：炒股，股票太多，操作又太复杂，不适合小白，于是有了基金，基金是把多只票放到一个篮子里，然后小白只需要购买基金就能安心理财！
