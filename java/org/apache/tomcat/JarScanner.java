 ...
 * include TLD scanning and web-fragment-1.xml scanning. Uses a call-back
...
public interface JarScanner {
     ...
     * 扫描所提供的ServletContext和类加载器以查找JAR文件。找到的每个JAR文件都将传递给回调处理程序进行处理。
     * @param scanType      The type of JAR scan to perform. This is passed to
     *                          the filter which uses it to determine how to
     *                          filter the results 扫描的类型（TLD，PLUGGABILITY，OTHER）
     * @param context       The ServletContext - used to locate and access
     *                      WEB-INF/lib
     * @param callback      The handler to process any JARs found
     */
    public void
    scan(JarScanType scanType, ServletContext context,
