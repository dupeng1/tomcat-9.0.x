...
public class SetNextRule extends Rule {
    ...
    public void end(String namespace, String name) throws Exception {
        ...
        /**
         * 通过反射调用指定的方法, 比如：
         * Catalina的setServer(xxx)
         * StandardServer组件的addLifecycleListener、addService(xxx)等
         * StandardService组件的addConnector(xxx)
         * StandardEngine的setRealm(xxx)、addChild(xxx)方法等
         * StandardHost的addValve(xxx)方法等
         */
        IntrospectionUtils.callMethod1(parent, methodName,
            child, paramType, digester.getClassLoader());
//        System.out.println("======> parent :"+parent+", methodName :"+methodName+",methodParam: "+child);
