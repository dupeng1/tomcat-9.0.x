...
public class WebRuleSet implements RuleSet {
    ...
    /**
     * Flag that indicates if this ruleset is for a web-fragment-1.xml file or for
     * a web.xml file.
     */
    ...
    public WebRuleSet(String prefix, boolean fragment) {
        ...
        if(fragment) {
            /**web模块部署符片段匹配的标签是M<web-fragment></web-fragment>*/
            fullPrefix = prefix + "web-fragment";
        } else {
            /**web模块部署符匹配的标签是M<web-app></web-app>*/
            fullPrefix = prefix + "web-app";
        }

        /**
         * 关于执行顺序：web.xml肯定是第一个执行的
         *
         ...
         *
         * Web片段的相对排序：
         * fragment1 - web-fragment-1.xml
         * <web-fragment>
         *     <name>fragment1</name>
         *     <ordering><after><name>fragment2</name></after></ordering>
         *     ...
         * </web-fragment>
         * fragment2 - web-fragment-1.xml
         * <web-fragment>
         *     <name>fragment2</name>
         *     ...
         * </web-fragment>
         * fragment3 - web-fragment-1.xml
         * <web-fragment>
         *     <name>fragment3</name>
         ...
         *
         * 见名知其意：
         * fragment1在fragment2执行完后执行，所以顺序 fragment2 > fragment1
         * fragment3在所有fragment片段执行前执行，所以顺序 fragment3 > fragment2
         * 综上执行结果：
         * fragment3
         * fragment2
         * fragment1
