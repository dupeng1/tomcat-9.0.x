...
/**
 * Representation of common elements of web.xml and web-fragment-1.xml. Provides
...
public class WebXml extends XmlEncodingBase implements DocumentProperties.Charset {
     ...
     * Absolute Ordering
     * web.xml中仅有的元素，绝对排序，排序针对的是web-fragment
     */
    ...
    /**
     * web-fragment-1.xml only elements
     * Relative ordering
     * web-fragment.xml 特有的标签，即片段部署描述符中的filter或listener在其他片段配置执行之后在执行
     */
    ...
    // Optional metadata-complete attribute 可选的元数据完成属性
    /**元数据完整性，配置true，表示完全依赖于web.xml，不管其他注解或者SCI中的，如果false，则会走其他*/
    ...
    // Attributes not defined in web.xml or web-fragment-1.xml
    ...
    /**
     * Generates the sub-set of the web-fragment-1.xml files to be processed in
     ...
     *                       with
     * @return Ordered list of web-fragment-1.xml files to process
     */
