 ...
 * end of the chain.
 *
 * FilterChain是servlet容器提供给开发人员的对象，用于查看筛选后的资源请求的调用链。
 * 过滤器使用FilterChain调用链中的下一个过滤器，或者如果调用过滤器是链中的最后一个过滤器，则调用链末尾的资源。
 *
 * @see Filter
 * @since Servlet 2.3
 **/
...
public interface FilterChain {
     ...
     * 使链中的下一个过滤器被调用，或者如果调用过滤器是链中的最后一个过滤器，则使链末端的资源被调用
     * @param request
