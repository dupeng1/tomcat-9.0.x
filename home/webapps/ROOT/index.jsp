...
%>
<%@ page import="com.appleyk.model.Person" %>
<%
  Person person = new Person("appleyk");
  /**将person对象塞入到当前的request对象中，然后jsp中可以将这个值通过el表达式渲染到页面上*/
...
<html lang="en">
    ...
    <body>
        <div>
            <%--jsp会编译成servlet类，然后使用Tomcat的EL表达时对下面的变量进行解析和替换--%>
            Tomcat9.x源码调试者名称：${person.name}
        </div>
        <div id="wrapper">
